...
4. **Slides:**
   The repository also includes slides from the video lectures which the notes were made on. These slides provide a visual representation of the concepts discussed and can be found [here](https://github.com/franpanteli/Python-Bootcamp-Module-20-Advanced-Objects-and-Data-Structures/tree/main).
